...
> 当前版本状态：站点 `GUIDE_META` **v2.6.12**；万象棋 `WXQ_META` **v1.5.13**（浮窗复制修复、阶位、图鉴悬停开关）。官方阵容库 **v1.2.0**（47 套）。近7日数据阵容 **v1.1.0**。
...
- 「图鉴开/关」存 `localStorage wxq-hud-db`（默认开）。开时悬停英雄/装备弹出官方卡面摘要（阶、阵营、desc、合成），不是模拟打架。游戏全屏独占会挡住网页，需窗口化。
