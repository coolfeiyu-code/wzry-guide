...
> 当前版本状态：站点 `GUIDE_META` **v2.6.12**；万象棋 `WXQ_META` **v1.5.11**（在用阵容 + 对局浮窗）。官方阵容库 **v1.2.0**（47 套）。近7日数据阵容 **v1.1.0**。
...
- 浮窗内容：7×4 站位 + 讲解搭配/回合（若对得上）+ 该套 brief/ops 原文。不编胜率。游戏全屏独占会挡住网页，需窗口化。
